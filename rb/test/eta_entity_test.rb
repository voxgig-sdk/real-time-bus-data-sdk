...
class EtaEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set REALTIMEBUSDATA_TEST_ETA_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def eta_basic_setup(extra)
  ...
  entid_env_raw = ENV["REALTIMEBUSDATA_TEST_ETA_ENTID"]
