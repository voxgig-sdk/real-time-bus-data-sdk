...
#      offline in seeded test mode (RealTimeBusDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RealTimeBusData_sdk.rb")
  SDK_CLASS = "RealTimeBusDataSDK"
