# RealTimeBusData SDK Eta entity
...
class EtaEntity
  ...
  # @return [Eta, Hash] the current Eta data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Eta fields)
  def match_get
  ...
  # Load a single Eta.
  #
  # @param reqmatch [EtaLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Eta.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Eta, Hash] the loaded Eta; raises RealTimeBusDataError on failure
  ...
  #
  # @param reqmatch [EtaListMatch, Hash, nil] match filter (any subset of
  #   Eta fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Eta>, Array] the matching Eta items; raises RealTimeBusDataError on failure
