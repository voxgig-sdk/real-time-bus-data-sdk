...
class RouteStopEntity
  ...
  def make
    opts = @_entopts.dup
    RouteStopEntity.new(@_client, opts)
  end
  ...
  # @return [RouteStop, Hash] the current RouteStop data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RouteStop fields)
  def match_get
  ...
  #
  # @param reqmatch [RouteStopListMatch, Hash, nil] match filter (any subset of
  #   RouteStop fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<RouteStop>, Array] the matching RouteStop items; raises RealTimeBusDataError on failure
