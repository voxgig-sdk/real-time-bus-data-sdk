...
class StopEntity
  ...
  # @return [Stop, Hash] the current Stop data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Stop fields)
  def match_get
  ...
  # Load a single Stop.
  #
  # @param reqmatch [StopLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Stop.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Stop, Hash] the loaded Stop; raises RealTimeBusDataError on failure
  ...
  #
  # @param reqmatch [StopListMatch, Hash, nil] match filter (any subset of
  #   Stop fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Stop>, Array] the matching Stop items; raises RealTimeBusDataError on failure
