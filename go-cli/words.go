...
func registerSDKWords(r *eng.Registry, client *sdk.RealTimeBusDataSDK) {
...
func runOp(client *sdk.RealTimeBusDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
