...
describe("RouteStopDirect", function()
  it("should direct-list-route_stop", function()
    local setup = route_stop_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-route_stop", setup.live and "live" or "unit")
