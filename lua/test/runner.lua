...
function runner.env_override(m)
  local live = runner.getenv("REALTIMEBUSDATA_TEST_LIVE")
  local override = runner.getenv("REALTIMEBUSDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("REALTIMEBUSDATA_TEST_EXPLAIN")
