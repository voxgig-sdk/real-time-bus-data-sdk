...
function runner.env_override(m)
  local live = runner.getenv("REAL_TIME_BUS_DATA_TEST_LIVE")
  local override = runner.getenv("REAL_TIME_BUS_DATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("REAL_TIME_BUS_DATA_TEST_EXPLAIN")
