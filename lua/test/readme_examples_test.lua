...
local SDK_MODULE = "real-time-bus-data_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["eta"] = { ["test01"] = { id = "test01" } }, ["route"] = { ["test01"] = { id = "test01" } }, ["route_stop"] = { ["test01"] = { id = "test01" } }, ["stop"] = { ["test01"] = { id = "test01" } } } }'
