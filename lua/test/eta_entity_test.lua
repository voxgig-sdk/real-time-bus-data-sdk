...
describe("EtaEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set REALTIMEBUSDATA_TEST_ETA_ENTID JSON to run live")
      return
    end
...
function eta_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("REALTIMEBUSDATA_TEST_ETA_ENTID")
