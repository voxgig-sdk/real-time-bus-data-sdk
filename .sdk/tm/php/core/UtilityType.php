...
// RealTimeBusData SDK utility type

class RealTimeBusDataUtility
{
    ...
    public static function copy(RealTimeBusDataUtility $src): RealTimeBusDataUtility
    {
        $u = new RealTimeBusDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
