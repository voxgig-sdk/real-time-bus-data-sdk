...
// RealTimeBusData SDK metrics feature
...
class RealTimeBusDataMetricsFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _record(RealTimeBusDataContext $ctx, bool $ok): void
    {
