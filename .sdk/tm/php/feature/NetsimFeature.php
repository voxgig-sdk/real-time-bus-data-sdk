...
// RealTimeBusData SDK netsim feature
...
class RealTimeBusDataNetsimFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _simulate(RealTimeBusDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RealTimeBusDataContext $ctx, array $applied): void
    {
        $client = $this->client;
