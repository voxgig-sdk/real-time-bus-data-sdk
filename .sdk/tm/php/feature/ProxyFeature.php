...
// RealTimeBusData SDK proxy feature
...
class RealTimeBusDataProxyFeature extends RealTimeBusDataBaseFeature
{
    ...
    public function init(RealTimeBusDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RealTimeBusDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
