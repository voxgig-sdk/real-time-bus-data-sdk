...
// RealTimeBusData SDK clienttrack feature
...
class RealTimeBusDataClienttrackFeature extends RealTimeBusDataBaseFeature
{
    ...
    public function PostConstruct(RealTimeBusDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RealTimeBusData-SDK';
