...
// RealTimeBusData SDK cache feature
...
class RealTimeBusDataCacheFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _through(RealTimeBusDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
