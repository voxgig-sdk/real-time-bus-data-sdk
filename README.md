...
This API provides real-time arrival data for Kowloon Motor Bus and Long Win Bus services.

Learn more about Real Time Bus Data at [data.etabus.gov.hk](https://data.etabus.gov.hk).
...
This SDK exposes the API as a small set of **semantic entities** — Eta, Route, RouteStop and Stop — that you
...
const eta = await client.Eta().load({ stop_id: "example" })
```
...
// stops is an array of Stop entities, populated with mock data
// — call stops[0].data() for the record itself
console.log(stops)
```
...
```go
client := sdk.Test()
result, err := client.Stop(nil).List(
    nil, nil,
)
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/real-time-bus-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/real-time-bus-data-sdk/releases) |
| Python | `voxgig-sdk-real-time-bus-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/real-time-bus-data-sdk/releases) |
| PHP | `voxgig-sdk/real-time-bus-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/real-time-bus-data-sdk/releases) |
| Golang | `github.com/voxgig-sdk/real-time-bus-data-sdk/go` | `go get github.com/voxgig-sdk/real-time-bus-data-sdk/go@latest` |
| Ruby | `voxgig-sdk-real-time-bus-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/real-time-bus-data-sdk/releases) |
| Lua | `voxgig-sdk-real-time-bus-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/real-time-bus-data-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/real-time-bus-data-sdk/go-cli` | `go install github.com/voxgig-sdk/real-time-bus-data-sdk/go-cli/cmd/real-time-bus-data@latest` |
| Go MCP server | `github.com/voxgig-sdk/real-time-bus-data-sdk/go-mcp` | `go get github.com/voxgig-sdk/real-time-bus-data-sdk/go-mcp@latest` |
...
// Load a specific eta (returns a Eta)
...
| --- | --- | --- |
| **Eta** | The Eta entity (load). | `/v1/transport/kmb/eta/{stop_id}/{route}/{service_type}` |
| **Route** | The Route entity (list, load). | `/v1/transport/kmb/route` |
| **RouteStop** | The RouteStop entity (list, load). | `/v1/transport/kmb/route-stop` |
| **Stop** | The Stop entity (list, load). | `/v1/transport/kmb/stop` |
...
eta, err := client.Eta(nil).Load(
    map[string]any{"stop_id": "example_stop_id"}, nil,
)
if err != nil {
    panic(err)
}
