# RealTimeBusData Golang SDK

The Golang SDK for the RealTimeBusData API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/real-time-bus-data-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/real-time-bus-data-sdk=../path/to/github.com/voxgig-sdk/real-time-bus-data-sdk
```
...
### Entity interface (RealTimeBusDataEntity)

All entities implement the `RealTimeBusDataEntity` interface.
...
Create an instance: `eta := client.Eta(nil)`
...
```
github.com/voxgig-sdk/real-time-bus-data-sdk/
├── real-time-bus-data.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/real-time-bus-data-sdk`) re-exports everything needed
