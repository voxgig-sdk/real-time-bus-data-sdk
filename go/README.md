...
```bash
go mod edit -replace github.com/voxgig-sdk/real-time-bus-data-sdk/go=../path/to/github.com/voxgig-sdk/real-time-bus-data-sdk/go
```
...
```
github.com/voxgig-sdk/real-time-bus-data-sdk/go/
...
The root package (`github.com/voxgig-sdk/real-time-bus-data-sdk/go`) re-exports everything needed
