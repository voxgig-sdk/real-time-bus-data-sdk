...
## Install
```bash
go get github.com/voxgig-sdk/real-time-bus-data-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/real-time-bus-data-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/real-time-bus-data-sdk/go=../real-time-bus-data-sdk/go
```
