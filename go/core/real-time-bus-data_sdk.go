...
type RealTimeBusDataSDK struct {
	Mode     string
...
func (sdk *RealTimeBusDataSDK) OptionsMap() map[string]any {
...
func (sdk *RealTimeBusDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RealTimeBusDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RealTimeBusDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RealTimeBusDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RealTimeBusDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RealTimeBusDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RealTimeBusDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RealTimeBusDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RealTimeBusDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RealTimeBusDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RealTimeBusDataSDK {
	if sdkopts == nil {
	...
	sdk := NewRealTimeBusDataSDK(sdkopts)
	sdk.Mode = "test"
