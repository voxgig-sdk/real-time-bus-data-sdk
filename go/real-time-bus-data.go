...
// instead of `sdk.NewRealTimeBusDataSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *RealTimeBusDataSDK  { return NewRealTimeBusDataSDK(nil) }
func Test() *RealTimeBusDataSDK { return TestSDK(nil, nil) }
