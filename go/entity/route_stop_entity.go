...
func NewRouteStopEntity(client *core.RealTimeBusDataSDK, entopts map[string]any) *RouteStopEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RouteStopEntity) GetName() string { return e.name }
...
func (e *RouteStopEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RouteStopEntity) Deleted() bool {
	return e.deleted
}


func (e *RouteStopEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRouteStopEntity(e.client, opts)
}

func (e *RouteStopEntity) Data(args ...any) any {
...
func (e *RouteStopEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RouteStop; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RouteStopEntity) DataTyped(data ...RouteStop) RouteStop {
	if len(data) > 0 {
		return typedFrom[RouteStop](e.Data(asMap(data[0])))
	}
	return typedFrom[RouteStop](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RouteStop (all fields
// optional at the wire level).
func (e *RouteStopEntity) MatchTyped(match ...RouteStop) RouteStop {
	if len(match) > 0 {
		return typedFrom[RouteStop](e.Match(asMap(match[0])))
	}
	return typedFrom[RouteStop](e.Match())
}
...
func (e *RouteStopEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RouteStopEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RouteStopLoadMatch and returns an RouteStop. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RouteStopEntity) LoadTyped(reqmatch RouteStopLoadMatch, ctrl map[string]any) (RouteStop, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RouteStop{}, err
	}
	return typedFrom[RouteStop](res), nil
}




func (e *RouteStopEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RouteStopListMatch and returns []RouteStop. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RouteStopEntity) ListTyped(reqmatch RouteStopListMatch, ctrl map[string]any) ([]RouteStop, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[RouteStop](res), nil
}



func (e *RouteStopEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RouteStopEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RouteStopEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RouteStopEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
