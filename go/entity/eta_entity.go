...
func NewEtaEntity(client *core.RealTimeBusDataSDK, entopts map[string]any) *EtaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EtaEntity) GetName() string { return e.name }
...
func (e *EtaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EtaEntity) Deleted() bool {
	return e.deleted
}


func (e *EtaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEtaEntity(e.client, opts)
}

func (e *EtaEntity) Data(args ...any) any {
...
func (e *EtaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Eta; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EtaEntity) DataTyped(data ...Eta) Eta {
	if len(data) > 0 {
		return typedFrom[Eta](e.Data(asMap(data[0])))
	}
	return typedFrom[Eta](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Eta (all fields
// optional at the wire level).
func (e *EtaEntity) MatchTyped(match ...Eta) Eta {
	if len(match) > 0 {
		return typedFrom[Eta](e.Match(asMap(match[0])))
	}
	return typedFrom[Eta](e.Match())
}
...
func (e *EtaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EtaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EtaLoadMatch and returns an Eta. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EtaEntity) LoadTyped(reqmatch EtaLoadMatch, ctrl map[string]any) (Eta, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Eta{}, err
	}
	return typedFrom[Eta](res), nil
}
...
func (e *EtaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EtaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EtaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
