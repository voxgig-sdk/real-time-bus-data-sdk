...
func NewStopEntity(client *core.RealTimeBusDataSDK, entopts map[string]any) *StopEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StopEntity) GetName() string { return e.name }
...
func (e *StopEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StopEntity) Deleted() bool {
	return e.deleted
}


func (e *StopEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStopEntity(e.client, opts)
}

func (e *StopEntity) Data(args ...any) any {
...
func (e *StopEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Stop; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StopEntity) DataTyped(data ...Stop) Stop {
	if len(data) > 0 {
		return typedFrom[Stop](e.Data(asMap(data[0])))
	}
	return typedFrom[Stop](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Stop (all fields
// optional at the wire level).
func (e *StopEntity) MatchTyped(match ...Stop) Stop {
	if len(match) > 0 {
		return typedFrom[Stop](e.Match(asMap(match[0])))
	}
	return typedFrom[Stop](e.Match())
}
...
func (e *StopEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StopEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StopLoadMatch and returns an Stop. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StopEntity) LoadTyped(reqmatch StopLoadMatch, ctrl map[string]any) (Stop, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Stop{}, err
	}
	return typedFrom[Stop](res), nil
}




func (e *StopEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// StopListMatch and returns []Stop. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StopEntity) ListTyped(reqmatch StopListMatch, ctrl map[string]any) ([]Stop, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Stop](res), nil
}



func (e *StopEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StopEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StopEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StopEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
