...
func TestEtaEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set REALTIMEBUSDATA_TEST_ETA_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func etaBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("REALTIMEBUSDATA_TEST_ETA_ENTID")
