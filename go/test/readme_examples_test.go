...
const testSeed = `map[string]any{"entity": map[string]any{"eta": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "route": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "route_stop": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stop": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
