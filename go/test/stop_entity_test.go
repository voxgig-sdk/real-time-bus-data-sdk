...
func TestStopEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set REALTIMEBUSDATA_TEST_STOP_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func stopBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("REALTIMEBUSDATA_TEST_STOP_ENTID")
	...
	idmapResolved := core.ToMapAny(env["REALTIMEBUSDATA_TEST_STOP_ENTID"])
