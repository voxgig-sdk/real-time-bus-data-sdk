# RealTimeBusData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RealTimeBusDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RealTimeBusDataSDK(...) and RealTimeBusDataSDK.test(...) become
#      RealTimeBusDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "realtimebusdata_sdk"
_SDK_CLASS = "RealTimeBusDataSDK"
