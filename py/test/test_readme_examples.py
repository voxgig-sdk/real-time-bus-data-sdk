# RealTimeBusData SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from realtimebusdata_sdk import RealTimeBusDataSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"RealTimeBusDataSDK": RealTimeBusDataSDK, "os": os}
        try:
