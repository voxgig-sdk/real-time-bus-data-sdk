...
from realtimebusdata_sdk.utility import register

# Load features
from realtimebusdata_sdk.feature.base_feature import RealTimeBusDataBaseFeature
from realtimebusdata_sdk.features import _has_feature, _make_feature
...
class RealTimeBusDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RealTimeBusDataUtility()
    ...
    def get_utility(self):
        return RealTimeBusDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RealTimeBusDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Eta(self, data=None) -> "EtaEntity":
        ...
        from realtimebusdata_sdk.entity.eta_entity import EtaEntity
        return EtaEntity(self, data)


    def Route(self, data=None) -> "RouteEntity":
        """Entity factory: client.Route().list() / client.Route().load({"id": ...})."""
        from realtimebusdata_sdk.entity.route_entity import RouteEntity
    ...
    def RouteStop(self, data=None) -> "RouteStopEntity":
        ...
        from realtimebusdata_sdk.entity.route_stop_entity import RouteStopEntity
        return RouteStopEntity(self, data)


    def Stop(self, data=None) -> "StopEntity":
        """Entity factory: client.Stop().list() / client.Stop().load({"id": ...})."""
        from realtimebusdata_sdk.entity.stop_entity import StopEntity
