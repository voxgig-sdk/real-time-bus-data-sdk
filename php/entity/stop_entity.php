...
class StopEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StopEntity($this->_client, $opts);
    }

    /**
     * @param Stop|array $args Stop data (assoc-array) to store.
     */
    ...
    /**
     * @return Stop|array The current Stop data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Stop fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Stop fields).
     */
     ...
     * Load a single Stop.
     *
     * @param StopLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StopLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Stop|array The loaded Stop as an assoc-array at the
    ...
    /**
     * List Stop items matching the given filter.
     *
     * @param StopListMatch|array|null $reqmatch Match filter (any subset
     *   of Stop fields) as an assoc-array; StopListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Stop[]|array A list of Stop items as assoc-arrays at
