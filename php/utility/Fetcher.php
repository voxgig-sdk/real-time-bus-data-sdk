...
// RealTimeBusData SDK utility: fetcher
...
class RealTimeBusDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RealTimeBusDataSDK/1.0)';
    ...
    public static function call(RealTimeBusDataContext $ctx, string $fullurl, array $fetchdef): array
    {
