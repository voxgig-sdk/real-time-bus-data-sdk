...
// RealTimeBusData SDK utility: graphql
//
...
class RealTimeBusDataGraphql
{
    ...
    // equivalent.
    public static function body(RealTimeBusDataContext $ctx): mixed
    {
    ...
    public static function errors(RealTimeBusDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
