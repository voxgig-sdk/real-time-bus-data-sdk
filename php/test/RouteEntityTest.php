...
class RouteEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set REALTIMEBUSDATA_TEST_ROUTE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function route_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("REALTIMEBUSDATA_TEST_ROUTE_ENTID");
