...
// RealTimeBusData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RealTimeBusDataSDK::test)
...
{
    private const SDK_CLASS = 'RealTimeBusDataSDK';
    ...
    private const SDK_BASE = 'realtimebusdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../realtimebusdata_sdk.php';
