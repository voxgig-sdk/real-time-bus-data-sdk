...
// RealTimeBusData SDK audit feature
...
class RealTimeBusDataAuditFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _emit(RealTimeBusDataContext $ctx, string $outcome): void
    {
