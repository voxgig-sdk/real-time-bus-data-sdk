...
// RealTimeBusData SDK idempotency feature
...
class RealTimeBusDataIdempotencyFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _mutating(RealTimeBusDataContext $ctx): bool
    {
