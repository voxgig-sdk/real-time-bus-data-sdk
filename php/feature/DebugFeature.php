...
// RealTimeBusData SDK debug feature
...
class RealTimeBusDataDebugFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _finish(RealTimeBusDataContext $ctx, bool $ok): void
    {
