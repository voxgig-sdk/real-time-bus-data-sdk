...
// RealTimeBusData SDK timeout feature
...
class RealTimeBusDataTimeoutFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _with_timeout(RealTimeBusDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RealTimeBusDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
