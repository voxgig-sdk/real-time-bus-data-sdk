...
// RealTimeBusData SDK streaming feature
...
class RealTimeBusDataStreamingFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _iterate(RealTimeBusDataResult $result): \Generator
    {
    ...
    private function _streamable(RealTimeBusDataContext $ctx): bool
    {
