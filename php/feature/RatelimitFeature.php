...
// RealTimeBusData SDK ratelimit feature
...
class RealTimeBusDataRatelimitFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _acquire(RealTimeBusDataContext $ctx): void
    {
    ...
    private function _track(RealTimeBusDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
