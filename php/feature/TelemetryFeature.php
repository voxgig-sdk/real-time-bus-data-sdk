...
// RealTimeBusData SDK telemetry feature
...
class RealTimeBusDataTelemetryFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _close(RealTimeBusDataContext $ctx, bool $ok): void
    {
