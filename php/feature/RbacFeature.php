...
// RealTimeBusData SDK rbac feature
...
class RealTimeBusDataRbacFeature extends RealTimeBusDataBaseFeature
{
    ...
    private function _required(RealTimeBusDataContext $ctx): ?string
    {
    ...
    private function _reject(RealTimeBusDataContext $ctx, string $required): void
    {
    ...
    private function _track(RealTimeBusDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
