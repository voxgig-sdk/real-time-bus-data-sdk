...
describe('EtaDirect', async () => {
  ...
  test('direct-load-eta', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-eta', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['REAL_TIME_BUS_DATA_TEST_ETA_ENTID']
