...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/eta/EtaTestData.json')
  ...
  let idmap = transform(
    ['eta01','eta02','eta03','eta01','eta02','eta03','route_eta01','route_eta02','route_eta03','stop_eta01','stop_eta02','stop_eta03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
  ...
  const idmapEnvVal = process.env['REAL_TIME_BUS_DATA_TEST_ETA_ENTID']
  ...
  idmap = env['REAL_TIME_BUS_DATA_TEST_ETA_ENTID']
