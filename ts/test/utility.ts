...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.REALTIMEBUSDATA_TEST_LIVE ||
    'TRUE' === process.env.REALTIMEBUSDATA_TEST_OVERRIDE
  ) {
  ...
  m.REALTIMEBUSDATA_TEST_EXPLAIN = process.env.REALTIMEBUSDATA_TEST_EXPLAIN || m.REALTIMEBUSDATA_TEST_EXPLAIN
