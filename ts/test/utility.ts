...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.REAL_TIME_BUS_DATA_TEST_LIVE ||
    'TRUE' === process.env.REAL_TIME_BUS_DATA_TEST_OVERRIDE
  ) {
  ...
  m.REAL_TIME_BUS_DATA_TEST_EXPLAIN = process.env.REAL_TIME_BUS_DATA_TEST_EXPLAIN || m.REAL_TIME_BUS_DATA_TEST_EXPLAIN
