...
describe('exists', async () => {
  ...
  //
  // RealTimeBusDataSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof RealTimeBusDataSDK, true,
      'RealTimeBusDataSDK.test() must return a client synchronously')
  })
