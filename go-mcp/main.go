// Command RealTimeBusData-mcp is an MCP server exposing the RealTimeBusData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RealTimeBusData_list  — list records of an entity
//	RealTimeBusData_load  — load a single record of an entity
//
